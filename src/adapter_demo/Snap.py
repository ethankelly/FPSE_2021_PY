...
class Snap:
    ...
    def play_card(self, current_score, hands, counter):
        if self.computer_hand == counter % 2:
            ...
            # "hands" is a list of lists of cards. The constant play_card.user_hand is used to get the hand of cards
            # for the user
    ...
    Description: Determine if the computer or the user has won and display the result. If the user call snap they must
    do it in a given time set by the user.
    """
